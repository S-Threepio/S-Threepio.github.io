  ...
  return (
    <div className="flex flex-col h-screen m-0">
      ...
      <div className="flex flex-row flex-1 w-screen overflow-hidden">
        ...
        <div className="flex flex-[4] flex-col items-center sm:flex-row justify-center pad:left-[10%] pad:absolute top-[20%] lg:left-[19%] tablet:left-[20%]  xl:left-[30%] scale-105">
          <CardSection />
          <Bio />
        </div>
      </div>
