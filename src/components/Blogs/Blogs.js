...
const Blogs = () => {
  ...
  return (
    <div className="w-screen flex flex-1 flex-col items-center bg-white z-50 overflow-scroll">
      ...
      />
      <div className="flex-col flex w-3/5 mb-10 items-center">
        <div className="text-5xl font-bold p-4 mb-10">My Blogs</div>
        <div className="mx-32 m-10 font-serif text-lg text-justify">
        ...
        <div className=" w-4/5 border-b-[1px] border-gray-800 mb-20" />
