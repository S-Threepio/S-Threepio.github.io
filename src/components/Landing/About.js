...
const About = () => {
  ...
  return (
    <div
      className={`flex-col flex-1 w-screen overflow-scroll md:flex-row md:flex scrollbar-hide md:scale-105
      ${shouldEnableScroll ? "md:overflow-scroll" : "md:overflow-hidden"}`}
    >
